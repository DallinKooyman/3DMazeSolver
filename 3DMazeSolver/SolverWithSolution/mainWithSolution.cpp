...
std::string is_valid_path(vector<string> &vec, std::string mazeString) {
	...
	for (unsigned int i = 0; i < vec.size(); i++) { // load the maze string into pathSS
	...
	for (unsigned int i = 0; i < vec.size(); i++) { // for each of the coordinates given:
